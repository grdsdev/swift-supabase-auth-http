        ...
        @frozen public enum Output: Sendable, Hashable {
            public struct Ok: Sendable, Hashable {
                ...
                @frozen public enum Body: Sendable, Hashable {
                    ...
                    public struct JsonPayload: Codable, Hashable, Sendable {
                        /// - Remark: Generated from `#/paths/user/oauth/grants/GET/responses/200/content/json/GrantsPayload`.
                        public struct GrantsPayloadPayload: Codable, Hashable, Sendable {
                            /// Unique client identifier
                            ///
                            /// - Remark: Generated from `#/paths/user/oauth/grants/GET/responses/200/content/json/GrantsPayload/client_id`.
                            public var clientId: Swift.String?
                            /// Human-readable name of the client application
                            ///
                            /// - Remark: Generated from `#/paths/user/oauth/grants/GET/responses/200/content/json/GrantsPayload/client_name`.
                            public var clientName: Swift.String?
                            /// URL of the client application's homepage
                            ///
                            /// - Remark: Generated from `#/paths/user/oauth/grants/GET/responses/200/content/json/GrantsPayload/client_uri`.
                            public var clientUri: Swift.String?
                            /// URL of the client application's logo
                            ///
                            /// - Remark: Generated from `#/paths/user/oauth/grants/GET/responses/200/content/json/GrantsPayload/logo_uri`.
                            public var logoUri: Swift.String?
                            /// List of scopes granted to this client
                            ///
                            /// - Remark: Generated from `#/paths/user/oauth/grants/GET/responses/200/content/json/GrantsPayload/scopes`.
                            public var scopes: [Swift.String]?
                            /// Timestamp when grant was authorized
                            ///
                            /// - Remark: Generated from `#/paths/user/oauth/grants/GET/responses/200/content/json/GrantsPayload/granted_at`.
                            public var grantedAt: Foundation.Date?
                            /// Creates a new `GrantsPayloadPayload`.
                            ///
                            /// - Parameters:
                            ///   - clientId: Unique client identifier
                            ///   - clientName: Human-readable name of the client application
                        ...
                        /// - Remark: Generated from `#/paths/user/oauth/grants/GET/responses/200/content/json/grants`.
                        public typealias GrantsPayload = [Operations.GetUserOauthGrants.Output.Ok.Body.JsonPayload.GrantsPayloadPayload]
                        /// - Remark: Generated from `#/paths/user/oauth/grants/GET/responses/200/content/json/grants`.
                        public var grants: Operations.GetUserOauthGrants.Output.Ok.Body.JsonPayload.GrantsPayload?
                        /// Creates a new `JsonPayload`.
                        ///
                        /// - Parameters:
                        ///   - grants:
                        public init(grants: Operations.GetUserOauthGrants.Output.Ok.Body.JsonPayload.GrantsPayload? = nil) {
                            self.grants = grants
                        }
                        public enum CodingKeys: String, CodingKey {
                            case grants
